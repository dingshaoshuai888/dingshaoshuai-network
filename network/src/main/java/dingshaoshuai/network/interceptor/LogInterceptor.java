package dingshaoshuai.network.interceptor;

import static dingshaoshuai.network.util.LogKt.logI;

import android.text.TextUtils;

import dingshaoshuai.network.NetworkLibKt;
...
public class LogInterceptor implements Interceptor {
    ...
    public static String TAG = NetworkLibKt.getCommonLogTagHttp();
